...
const ultraCopy: Record<LanguageKey, {
  ...
  en: {
    hero: { label: "Ultra Mobile promos extended for September", title: 'Save with Ultra Mobile and get local activation help.', text: "Our Ultra Mobile offers continue in September: Unlimited for $25/month with six months prepaid for $150 through September 30, four Unlimited lines for $100/month, and every fourth month free on eligible monthly plans.", call: 'Call for Ultra Mobile', visit: 'Visit the store' },
    ...
    infoCards: [
      ...
      { icon: 'check', label: 'Limited time offer', title: 'Eligible 1-month 8GB+ plans can earn a free 4th month.', text: "Pay for three consecutive months on an eligible single-month 8GB+ plan and get the fourth month free. The 25GB plan is excluded. Service must continue uninterrupted; multi-month plans are separate offers." },
  ...
  pl: {
    hero: { label: "Promocje Ultra Mobile przedłużone na wrzesień", title: 'Plany Ultra Mobile, oszczędności rodzinne i obsługa gotowa na podróże w CellzTech.', text: "Promocje Ultra Mobile trwają we wrześniu: Unlimited za $25/mies. przy opłaceniu sześciu miesięcy z góry za $150 — oferta do 30 września; cztery linie Unlimited za $100/mies. oraz co czwarty miesiąc gratis w kwalifikujących się planach miesięcznych.", call: 'Zadzwoń w sprawie Ultra Mobile', visit: 'Odwiedź sklep' },
    ...
    infoCards: [
      ...
      { icon: 'check', label: 'Oferta czasowa', title: 'Wybrane miesięczne plany 8GB+ mogą otrzymać 4. miesiąc gratis.', text: "Opłać trzy kolejne miesiące kwalifikującego się planu jednomiesięcznego 8GB lub wyższego, a czwarty otrzymasz gratis. Plan 25GB jest wyłączony z promocji. Usługa musi być aktywna bez przerw; plany wielomiesięczne to osobne oferty." },
  ...
  es: {
    hero: { label: "Promociones Ultra Mobile extendidas a septiembre", title: 'Planes Ultra Mobile, ahorros familiares y servicio listo para viajar en CellzTech.', text: "Las ofertas Ultra Mobile continúan en septiembre: Unlimited por $25/mes al pagar seis meses por adelantado por $150, disponible hasta el 30 de septiembre; cuatro líneas Unlimited por $100/mes y cada cuarto mes gratis en planes mensuales elegibles.", call: 'Llamar sobre Ultra Mobile', visit: 'Visitar la tienda' },
    ...
    infoCards: [
      ...
      { icon: 'check', label: 'Oferta por tiempo limitado', title: 'Planes mensuales elegibles de 8GB+ pueden recibir el 4.º mes gratis.', text: "Paga tres meses consecutivos de un plan mensual elegible de 8GB o más y recibe el cuarto mes gratis. El plan de 25GB está excluido. El servicio debe continuar sin interrupciones; los planes de varios meses son ofertas separadas." },
  ...
  uk: {
    hero: { label: "Акції Ultra Mobile продовжено на вересень", title: 'Плани Ultra Mobile, сімейна економія та зв’язок для подорожей у CellzTech.', text: "Акції Ultra Mobile діють і у вересні: Unlimited за $25/міс. з передплатою $150 за шість місяців — пропозиція до 30 вересня; чотири лінії Unlimited за $100/міс. та кожен четвертий місяць безкоштовно на відповідних місячних планах.", call: 'Зателефонувати щодо Ultra Mobile', visit: 'Відвідати магазин' },
    ...
    infoCards: [
      ...
      { icon: 'check', label: 'Обмежена пропозиція', title: 'Вибрані місячні плани 8GB+ можуть отримати 4-й місяць безкоштовно.', text: "Оплатіть три місяці поспіль на відповідному місячному плані від 8GB та отримайте четвертий місяць безкоштовно. План 25GB не бере участі в акції. Послуга має діяти без перерв; багатомісячні плани є окремими пропозиціями." },
...
const simRequestCopy = {
  en: {
    ...
    title: 'Request Ultra Mobile SIM.',
    text: 'Choose a plan, SIM option, and contact details. CellzTech will call you soon to confirm availability, activation, shipping or pickup, and how to complete the order.',
    options: [
...
function UltraSimRequestPage({ lang }: { lang: LanguageKey }) {
  ...
  useEffect(() => {
    ...
    if (isFamily) {
      ...
      planInterest = planParam || 'September customer bonus inquiry';
      ...
      planInterest = planParam || 'September Ultra Mobile offers';
