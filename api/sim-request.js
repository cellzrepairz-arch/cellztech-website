...
function formatText(body) {
  return [
    ...
    `SIM quantity: ${body.raw_payload?.simQuantity || '1'}`,
    `Selected duration: ${body.raw_payload?.selectedDuration || 'Not provided'}`,
    `Selected price: ${body.raw_payload?.selectedPrice || 'Not provided'}`,
    `Selected billed total: ${body.raw_payload?.selectedBilled || 'Not provided'}`,
